...
{
    const char* pszTimestamp = "NASA shows laser-struck rock from Perseverance on Mars, 2021 ";
    const CScript genesisOutputScript = CScript() << ParseHex("04C7BECF094B53166F5D046DEE2E078EDDD0D0A69F99833CBC8F7E95701E4C25BA6BE1CE0652BB5FBE11159DB0E595BD2E98658603FC2982BB6C065D7D8BE81CD4") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("8febab3af23e9fc5882d2e66b756e1316432c214c887d087571a414736722f51");
        ...
        genesis = CreateGenesisBlock(1617423279, 1784032, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x8febab3af23e9fc5882d2e66b756e1316432c214c887d087571a414736722f51"));
        assert(genesis.hashMerkleRoot == uint256S("0xc60372984b57cbd6da7a28614427aa1977a8feba45a97277017b008268b9b5d3"));
        ...
        //vSeeds.emplace_back("seed-a.bitevelin.loshan.co.uk");
        //vSeeds.emplace_back("dnsseed.thrasher.io");
        //vSeeds.emplace_back("dnsseed.bitevelintools.com");
        //vSeeds.emplace_back("dnsseed.bitevelinpool.org");
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 411750, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x331bee8d7d5a3c14bc246ef060c89b199052600907538257ea343dce390fcfc1"));
        assert(genesis.hashMerkleRoot == uint256S("0xc60372984b57cbd6da7a28614427aa1977a8feba45a97277017b008268b9b5d3"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        //vSeeds.emplace_back("testnet-seed.bitevelintools.com");
        //vSeeds.emplace_back("seed-b.bitevelin.loshan.co.uk");
...
public:
    CRegTestParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x3e38819ef62b16cf5d87d8cbd20de6e0f0b3a51130e37601fd58ef9754206315"));
        assert(genesis.hashMerkleRoot == uint256S("0xc60372984b57cbd6da7a28614427aa1977a8feba45a97277017b008268b9b5d3"));
