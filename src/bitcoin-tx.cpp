...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " bitevelin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  bitevelin-tx [options] <hex-tx> [commands]  Update hex-encoded bitevelin transaction\n" +
            "or:     bitevelin-tx [options] -create [commands]   Create hex-encoded bitevelin transaction\n" +
            "\n";
