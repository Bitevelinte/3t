...
"""Verify that starting bitevelin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitevelin with -h for help text")
        ...
        self.log.info("Start bitevelin with -version for version information")
        ...
        self.log.info("Start bitevelind with -fakearg to make sure it does not start")
