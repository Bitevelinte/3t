...
* bitevelin.conf: contains configuration settings for bitevelind or bitevelin-qt
* bitevelind.pid: stores the process id of bitevelind while running
...
* debug.log: contains debug information and general logging generated by bitevelind or bitevelin-qt
