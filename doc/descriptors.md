# Support for Output Descriptors in Bitevelin Core

Since Bitevelin Core v0.17, there is support for Output Descriptors in the
...
on Bitevelin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Bitevelin Core wallets, a convenience function `combo` is
