...
Add other gitian builders keys to your gpg keyring, and/or refresh keys: See `../bitevelin/contrib/gitian-keys/README.md`.
...
space *do not upload these to the bitevelin.org server, nor put them in the torrent*.
